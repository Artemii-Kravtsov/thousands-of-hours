...
[Открыть проект в NBViewer](https://nbviewer.jupyter.org/github/Artemii-Kravtsov/thousands-of-hours/blob/master/2_prices_on_real_estate_market.ipynb)
<br>
...
## Содержание проекта 
- масштабная предобработка данных
- поиск корреляций между стоимостью объектов недвижимости и их характеристиками
